...
const MIMALLOC_VERSION = "3.3.2"
const MIMALLOC_HASH = "ca02384e007f46950598500dfaebde5ff9948c1d231f5a81b058799afa64bbbb"

const ZLIBNG_VERSION = "2.3.3"
const ZLIBNG_HASH = "f9c65aa9c852eb8255b636fd9f07ce1c406f061ec19a2e7d508b318ca0c907d1"
...
const AWSLC_VERSION = "1.73.0"
const AWSLC_HASH = "e33ae89e7d09d7b23a900f68b62088d8813c260ac564b016e543ee3540ebcce3"

const OPENSSL_VERSION = "4.0.0"
const OPENSSL_HASH = "c32cf49a959c4f345f9606982dd36e7d28f7c58b19c2e25d75624d2b3d2f79ac"
...
const NGHTTP3_VERSION = "1.16.0"
const NGHTTP3_HASH = "776f59a99905c9a348846807b2e5ac9bb3485fc0f8c0250ba803018d5238a16e"

# nghttp2-${NGHTTP2_VERSION}.tar.xz
const NGHTTP2_VERSION = "1.69.0"
const NGHTTP2_HASH = "1fb324b6ec2c56f6bde0658f4139ffd8209fa9e77ce98fd7a5f63af8d0e508ad"

# ngtcp2-${NGTCP2_VERSION}.tar.xz
const NGTCP2_VERSION = "1.23.0"
const NGTCP2_HASH = "59d5b4211e96970f2d3d5e6876f73dce03414800ba04aa56835b132fce8de730"

# curl-${CURL_VERSION}.tar.xz
const CURL_VERSION = "8.20.0"
const CURL_HASH = "63fe2dc148ba0ceae89922ef838f7e5c946272c2e78b7c59fab4b79d3ce2b896"
...
def main [
    --target (-T): string = "x86_64-linux-gnu" # Compile git for the given target
    ...
    # ngtcp2
    if not (WebUnarchive -u $NGTCP2_URL -o $"($NGTCP2_DIRNAME).tar.xz" -H $NGTCP2_HASH) {
        exit 1
    }
    # pcre2
    ...
    mut gitOptions = [
        ...
        $"--with-libpcre2=($QUARANTINE_PREFIX)"
        $"LIBS=($CURL_LDFLAGS)"
