...
curl -o nfpm_2.45.0_Linux_x86_64.tar.gz -L https://github.com/goreleaser/nfpm/releases/download/v2.45.0/nfpm_2.45.0_Linux_x86_64.tar.gz || exit
tar -xvf nfpm_2.45.0_Linux_x86_64.tar.gz || exit
